...
Gem::Specification.new do |s|
	s.name			= 'execute'
	s.version		= '0.1.0'
	s.summary		= 'Class to execute system commands, basically a system command with state'
	s.description	= 'Class to execute system commands, basically a system command with state'
